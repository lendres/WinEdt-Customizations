...
\begin{numberedlist}
	...
	\item Find the location to put the new menu items.  That is after the end of the \textcode{ITEM="TeXify"} or the end of the \textcode{ITEM="XeLaTeX"} menu items.  The new entries will be added after the item, i.e., after the \textcode{REQ\_FILTER...} line.
...
\begin{figure}
	...
	\caption[The location of \textcode{Additional Preferences} on the \textit{Options Interface} panel]{The location of \textcode{Additional Preferences} on the \textit{Options Interface} panel.  Form \emph{WinEdt 11} the \emph{Application:} prefix is not used.}
